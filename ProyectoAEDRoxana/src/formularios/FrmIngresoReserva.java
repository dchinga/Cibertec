...
public class FrmIngresoReserva extends JFrame implements ActionListener,
	...
	private FrmIngresoReserva() {
		...
		contentPane.setLayout(null);
		{
			...
			{
				lblMaterial = new JLabel("Reservaciones");
			...
			}
			{
				...
				{
					lblCosto = new JLabel("FEC INGRESO");
								...
								{
									{
										...
										table.setModel(new DefaultTableModel(
												new Object[][] {},
												new String[] { "Número","COD Cli", 
														"COD Recep", "N° Habi",
														"Fec Registro", "Fec Ingreso",
														"Fec SAlida", "Estado" }));
	...
	private void mostrarDatosHabitacion(Reserva obj) {
		...
		txtFecSalida.setText(""+obj.getFechaSalida());
	}
