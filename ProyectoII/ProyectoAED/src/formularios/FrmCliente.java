		...
		{
			{
				...
				btnAgregar.setIcon(new ImageIcon(FrmCliente.class
						.getResource("/recursos/agregar.png")));
				pnlBotones.add(btnAgregar);
				btnEditar = new JButton("");
				btnEditar.setToolTipText("Editar");
				btnEditar.setIcon(new ImageIcon(FrmCliente.class
						.getResource("/recursos/editar.png")));
				pnlBotones.add(btnEditar);
				btnEliminar = new JButton("");
				btnEliminar.setIcon(new ImageIcon(FrmCliente.class
						.getResource("/recursos/eliminar.png")));
				btnEliminar.setToolTipText("Eliminar");
				pnlBotones.add(btnEliminar);
				btnGuardar = new JButton("");
				btnGuardar.setToolTipText("Aceptar");
				btnGuardar.setIcon(new ImageIcon(FrmCliente.class
						.getResource("/recursos/aceptar.png")));
				pnlBotones.add(btnGuardar);
				btnCancelar = new JButton("");
				btnCancelar.setIcon(new ImageIcon(FrmCliente.class
						.getResource("/recursos/cancelar.png")));
				btnCancelar.setToolTipText("Cancelar");
				pnlBotones.add(btnCancelar);
				btnConsultar = new JButton("");
				btnConsultar.setIcon(new ImageIcon(FrmCliente.class
						.getResource("/recursos/consultar.png")));
				btnConsultar.setToolTipText("Consultar");
				pnlBotones.add(btnConsultar);
				{
					btnListar = new JButton("");
					btnListar.setIcon(new ImageIcon(FrmCliente.class
			...
			{
				lblMaterial = new JLabel("Clientes");
			...
			}
			{
				...
				pnlCabecera.setIcon(new ImageIcon(FrmCliente.class.getResource("/recursos/cliente.png")));
